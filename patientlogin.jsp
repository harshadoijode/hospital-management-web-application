...
<script>
							...
							window.open("viewspecs.jsp","_self");
							</script>
...
<form id="form1" name="form1" method="post" action="">
  <table width="77%" height="213" border="0" align="center">
    <tr>
      ...
      <td width="230">
	  <input type="Email" name="username" required</td>
    </tr>
    <tr>
  ...
  <div align="right" class="style3">
    <p align="center"><a href="fergotpat.jsp" target="_self"> forgot password</a></p>
    <p align="center"><a href="newpat.jsp" target="_self"> New User?</a></p>
  </div>
</form>
</div>
</center></td>
