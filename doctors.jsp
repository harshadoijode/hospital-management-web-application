...
rst=stmt.executeQuery("select name,phoneno,email,Specialization,password from doctor ");

  
						
  %>
  <span class="style5">Doctors</span></span> </p>
  ...
  <tr bgcolor="#003300">
	...
	<td width="156"><div align="center" class="style4">Specialization</div></td>
